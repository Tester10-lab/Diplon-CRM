...
const INITIAL_INQUIRIES: TourInquiry[] = [
  {
    id: 'INQ-1001',
    customerName: 'Nirvik Sapkota',
    contactPhone: '9841876047',
    ...
    source: 'WhatsApp',
    status: 'NEW',
    notes: 'Requested Scorpio private vehicle, 2 rooms for 7 pax. Advance 5,000 paid.',
    createdAt: '2026-07-28 10:15'
  },
  {
    id: 'INQ-1002',
    customerName: 'Narayan Shrestha',
    contactPhone: '9841273144',
    ...
    source: 'Phone Call',
    status: 'QUOTED',
    notes: '2 Scorpio Jeeps required for 16 passengers. Asked for deluxe hotel rooms in Lo Manthang.',
    createdAt: '2026-07-28 09:30'
  },
  {
    id: 'INQ-1003',
    customerName: 'rojina shakya',
    contactPhone: '9860099335',
    packageName: 'Upper Mustang Jeep Safari',
    ...
    source: 'Viber',
    status: 'FOLLOW_UP',
    notes: 'Inquired about 2 rooms for 7 pax. Awaiting confirmation on pickup location.',
    createdAt: '2026-07-27 16:45'
  },
  {
    id: 'INQ-1004',
    customerName: 'Birat Raj Joshi',
    contactPhone: '9704775893',
    ...
    source: 'Website Form',
    status: 'NEW',
    notes: 'Looking for a licensed guide and tea house accommodation package.',
    createdAt: '2026-07-27 14:20'
  },
  {
    id: 'INQ-1005',
    customerName: 'bimala chetri',
    contactPhone: '9767648385',
    ...
    source: 'B2B Referral',
    status: 'CONVERTED',
    notes: 'Referred by Kathmandu B2B Agency. Booking confirmed.',
