          ...
          <div className="space-y-2 pt-2">
            ...
            <div className="grid grid-cols-1 gap-2">
              <button
                ...
                onClick={() => handleQuickDemoSelect('superadmin@diplon.com')}
              ...
              >
                <div>
                  ...
                  <div className="text-[11px] text-slate-400 font-mono">superadmin@diplon.com</div>
                </div>
                <span className="text-[10px] bg-amber-500/20 text-amber-300 font-bold px-2 py-0.5 rounded">Full Control</span>
              </button>

              <button
                type="button"
                disabled={isLockedOut}
                onClick={() => handleQuickDemoSelect('admin@diplon.com')}
                className={`p-3 rounded-2xl border text-left transition-all flex items-center justify-between ${
              ...
              >
                <div>
                  <div className="font-bold text-xs flex items-center gap-1.5 text-indigo-400">
                    <Building2 className="w-4 h-4" /> Company Admin
                  </div>
                  <div className="text-[11px] text-slate-400 font-mono">admin@diplon.com</div>
                </div>
                <span className="text-[10px] bg-indigo-500/20 text-indigo-300 font-bold px-2 py-0.5 rounded">Kathmandu Travels</span>
              </button>

              <button
                type="button"
                disabled={isLockedOut}
                onClick={() => handleQuickDemoSelect('agency@himalayan.com')}
                className={`p-3 rounded-2xl border text-left transition-all flex items-center justify-between ${
              ...
              >
                <div>
                  <div className="font-bold text-xs flex items-center gap-1.5 text-emerald-400">
                    <UserCheck className="w-4 h-4" /> Agency B2B Portal
                  </div>
                  <div className="text-[11px] text-slate-400 font-mono">agency@himalayan.com</div>
                </div>
                <span className="text-[10px] bg-emerald-500/20 text-emerald-300 font-bold px-2 py-0.5 rounded">Himalayan Agency</span>
              </button>

              <button
                type="button"
                disabled={isLockedOut}
                onClick={() => handleQuickDemoSelect('driver@diplon.com')}
                className={`p-3 rounded-2xl border text-left transition-all flex items-center justify-between ${
              ...
              >
                <div>
                  <div className="font-bold text-xs flex items-center gap-1.5 text-amber-300">
                    <Car className="w-4 h-4" /> Driver Portal
                  </div>
                  <div className="text-[11px] text-slate-400 font-mono">driver@diplon.com</div>
                </div>
                <span className="text-[10px] bg-amber-500/20 text-amber-300 font-bold px-2 py-0.5 rounded">Suman Dai (Scorpio #4)</span>
              </button>
            </div>
          </div>
        </div>
