...
export const mockDepartures: Departure[] = [
  { _id: 'dep_halesi_01', packageName: 'Halesi Tour Package (1N/2D)', startDate: '2026-08-01', endDate: '2026-08-02', seatsTotal: 28, seatsAvailable: 3, seatsReserved: 25, status: 'Active', travelerCount: 25, guideName: 'Unassigned Guide', driverName: 'Unassigned Driver', vehicleReg: '28-Seater Sofa Bus' },
  { _id: 'dep_jiri_02', packageName: 'Jiri Tour (1N/2D)', startDate: '2026-08-01', endDate: '2026-08-02', seatsTotal: 7, seatsAvailable: 1, seatsReserved: 6, status: 'Active', travelerCount: 6, guideName: 'Unassigned Guide', driverName: 'Unassigned Driver', vehicleReg: '4WD Scorpio Jeep' },
  { _id: 'dep_mustang_03', packageName: 'Upper Mustang Package (4N/5D)', startDate: '2026-10-28', endDate: '2026-11-01', seatsTotal: 7, seatsAvailable: 0, seatsReserved: 7, status: 'Active', travelerCount: 7, guideName: 'Unassigned Guide', driverName: 'Unassigned Driver', vehicleReg: '4WD Scorpio Jeep' },
  { _id: 'dep_muktinath_04', packageName: 'Muktinath Tour (2N/3D)', startDate: '2026-10-25', endDate: '2026-10-27', seatsTotal: 7, seatsAvailable: 5, seatsReserved: 2, status: 'Active', travelerCount: 2, guideName: 'Unassigned Guide', driverName: 'Unassigned Driver', vehicleReg: '4WD Scorpio Jeep' },
];
